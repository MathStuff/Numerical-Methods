function [pred] = gradient_descent(pred,hessian,grad)
    % Gradient descent algorithm for quadratic functions: f(X)=(1/2)X'Q-X'b
    ...
    %EXAMPLE:
    %
    %   [pred] = gradient_descent([0;0],[6 -2;-2 4],["6*x(1)-2*x(2)-2" ;"-2*x(1)+4*x(2)+1"])
    %
